...
var __vue_staticRenderFns__ = [];
  ...
  var __vue_inject_styles__ = function (inject) {
    if (!inject) { return }
    inject("data-v-3860d191_0", { source: ".drop-allowed.drop-in *{cursor:inherit!important}.drop-forbidden.drop-in,.drop-forbidden.drop-in *{cursor:no-drop!important}.drag-no-handle:hover,.drag-no-handle:hover *{cursor:move;cursor:grab}", map: undefined, media: undefined })
,inject("data-v-3860d191_1", { source: "html.drag-in-progress *{cursor:move!important;cursor:grabbing!important}", map: undefined, media: undefined })
,inject("data-v-3860d191_2", { source: ".__drag-image[data-v-3860d191]{position:fixed;top:-10000px;left:-10000px;will-change:left,top}", map: undefined, media: undefined });

  };
  /* scoped */
  var __vue_scope_id__ = "data-v-3860d191";
  /* module identifier */
  var __vue_module_identifier__ = "data-v-3860d191";
  /* functional template */
...
,inject("data-v-6cf267bc_1", { source: ".drop-allowed.drop-in *{cursor:inherit!important}.drop-forbidden.drop-in,.drop-forbidden.drop-in *{cursor:no-drop!important}", map: undefined, media: undefined });
  ...
  /* module identifier */
  var __vue_module_identifier__$4 = "data-v-6cf267bc";
  /* functional template */
