...
__vue_render__$4._withStripped = true;
  ...
  var __vue_inject_styles__$4 = function (inject) {
    if (!inject) { return }
    inject("data-v-7a2f667a_0", { source: ".drop-allowed.drop-in * {\n  cursor: inherit !important;\n}\n.drop-forbidden.drop-in, .drop-forbidden.drop-in * {\n  cursor: no-drop !important;\n}\n.drag-no-handle.drag-in {\n  cursor: move;\n  cursor: grab;\n}\n\n/*# sourceMappingURL=Drag.vue.map */", map: {"version":3,"sources":["/Users/lixing/Projects/Easy-DnD/lib/src/components/Drag.vue","Drag.vue"],"names":[],"mappings":"AA8BA;EACA,0BAAA;AC7BA;ADiCA;EACA,0BAAA;AC9BA;ADkCA;EACA,YAAA;EACA,YAAA;AC/BA;;AAEA,mCAAmC","file":"Drag.vue","sourcesContent":["<template>\n    <component :is=\"tag\" v-bind=\"$attrs\" v-on=\"$listeners\"\n               :class=\"cssClasses\">\n        <slot></slot>\n        <template v-for=\"(_, slot) of $scopedSlots\" v-slot:[slot]=\"scope\">\n            <slot :name=\"slot\" v-bind=\"scope\"/>\n        </template>\n        <div class=\"__drag-image\" ref=\"drag-image\">\n            <slot name=\"drag-image\"></slot>\n        </div>\n    </component>\n</template>\n\n<script lang=\"ts\">\nimport {Component, Prop} from \"vue-property-decorator\";\nimport DragMixin from \"../mixins/DragMixin\";\n\n@Component({})\nexport default class Drag extends DragMixin {\n\n    /**\n     * Tag to be used as root of this component. Defaults to div.\n     */\n    @Prop({default: 'div', type: [String, Object, Function]})\n    tag: any;\n\n}\n</script>\n\n<style lang=\"scss\">\n.drop-allowed.drop-in * {\n  cursor: inherit !important;\n}\n\n.drop-forbidden.drop-in {\n  &, * {\n    cursor: no-drop !important;\n  }\n}\n\n.drag-no-handle.drag-in {\n  cursor: move;\n  cursor: grab;\n}\n</style>\n\n<style lang=\"scss\">\nhtml.drag-in-progress * {\n  cursor: move !important;\n  cursor: grabbing !important;\n}\n</style>\n\n<style lang=\"scss\" scoped>\n/* Places a drag image out of sight while keeping its computed styles accessibles. */\n.__drag-image {\n  position: fixed;\n  top: -10000px;\n  left: -10000px;\n  will-change: left, top;\n}\n</style>",".drop-allowed.drop-in * {\n  cursor: inherit !important;\n}\n\n.drop-forbidden.drop-in, .drop-forbidden.drop-in * {\n  cursor: no-drop !important;\n}\n\n.drag-no-handle.drag-in {\n  cursor: move;\n  cursor: grab;\n}\n\n/*# sourceMappingURL=Drag.vue.map */"]}, media: undefined })
,inject("data-v-7a2f667a_1", { source: "html.drag-in-progress * {\n  cursor: move !important;\n  cursor: grabbing !important;\n}\n\n/*# sourceMappingURL=Drag.vue.map */", map: {"version":3,"sources":["/Users/lixing/Projects/Easy-DnD/lib/src/components/Drag.vue","Drag.vue"],"names":[],"mappings":"AA+CA;EACA,uBAAA;EACA,2BAAA;AC9CA;;AAEA,mCAAmC","file":"Drag.vue","sourcesContent":["<template>\n    <component :is=\"tag\" v-bind=\"$attrs\" v-on=\"$listeners\"\n               :class=\"cssClasses\">\n        <slot></slot>\n        <template v-for=\"(_, slot) of $scopedSlots\" v-slot:[slot]=\"scope\">\n            <slot :name=\"slot\" v-bind=\"scope\"/>\n        </template>\n        <div class=\"__drag-image\" ref=\"drag-image\">\n            <slot name=\"drag-image\"></slot>\n        </div>\n    </component>\n</template>\n\n<script lang=\"ts\">\nimport {Component, Prop} from \"vue-property-decorator\";\nimport DragMixin from \"../mixins/DragMixin\";\n\n@Component({})\nexport default class Drag extends DragMixin {\n\n    /**\n     * Tag to be used as root of this component. Defaults to div.\n     */\n    @Prop({default: 'div', type: [String, Object, Function]})\n    tag: any;\n\n}\n</script>\n\n<style lang=\"scss\">\n.drop-allowed.drop-in * {\n  cursor: inherit !important;\n}\n\n.drop-forbidden.drop-in {\n  &, * {\n    cursor: no-drop !important;\n  }\n}\n\n.drag-no-handle.drag-in {\n  cursor: move;\n  cursor: grab;\n}\n</style>\n\n<style lang=\"scss\">\nhtml.drag-in-progress * {\n  cursor: move !important;\n  cursor: grabbing !important;\n}\n</style>\n\n<style lang=\"scss\" scoped>\n/* Places a drag image out of sight while keeping its computed styles accessibles. */\n.__drag-image {\n  position: fixed;\n  top: -10000px;\n  left: -10000px;\n  will-change: left, top;\n}\n</style>","html.drag-in-progress * {\n  cursor: move !important;\n  cursor: grabbing !important;\n}\n\n/*# sourceMappingURL=Drag.vue.map */"]}, media: undefined })
,inject("data-v-7a2f667a_2", { source: "/* Places a drag image out of sight while keeping its computed styles accessibles. */\n.__drag-image[data-v-7a2f667a] {\n  position: fixed;\n  top: -10000px;\n  left: -10000px;\n  will-change: left, top;\n}\n\n/*# sourceMappingURL=Drag.vue.map */", map: {"version":3,"sources":["/Users/lixing/Projects/Easy-DnD/lib/src/components/Drag.vue","Drag.vue"],"names":[],"mappings":"AAsDA,oFAAA;AACA;EACA,eAAA;EACA,aAAA;EACA,cAAA;EACA,sBAAA;ACrDA;;AAEA,mCAAmC","file":"Drag.vue","sourcesContent":["<template>\n    <component :is=\"tag\" v-bind=\"$attrs\" v-on=\"$listeners\"\n               :class=\"cssClasses\">\n        <slot></slot>\n        <template v-for=\"(_, slot) of $scopedSlots\" v-slot:[slot]=\"scope\">\n            <slot :name=\"slot\" v-bind=\"scope\"/>\n        </template>\n        <div class=\"__drag-image\" ref=\"drag-image\">\n            <slot name=\"drag-image\"></slot>\n        </div>\n    </component>\n</template>\n\n<script lang=\"ts\">\nimport {Component, Prop} from \"vue-property-decorator\";\nimport DragMixin from \"../mixins/DragMixin\";\n\n@Component({})\nexport default class Drag extends DragMixin {\n\n    /**\n     * Tag to be used as root of this component. Defaults to div.\n     */\n    @Prop({default: 'div', type: [String, Object, Function]})\n    tag: any;\n\n}\n</script>\n\n<style lang=\"scss\">\n.drop-allowed.drop-in * {\n  cursor: inherit !important;\n}\n\n.drop-forbidden.drop-in {\n  &, * {\n    cursor: no-drop !important;\n  }\n}\n\n.drag-no-handle.drag-in {\n  cursor: move;\n  cursor: grab;\n}\n</style>\n\n<style lang=\"scss\">\nhtml.drag-in-progress * {\n  cursor: move !important;\n  cursor: grabbing !important;\n}\n</style>\n\n<style lang=\"scss\" scoped>\n/* Places a drag image out of sight while keeping its computed styles accessibles. */\n.__drag-image {\n  position: fixed;\n  top: -10000px;\n  left: -10000px;\n  will-change: left, top;\n}\n</style>","/* Places a drag image out of sight while keeping its computed styles accessibles. */\n.__drag-image {\n  position: fixed;\n  top: -10000px;\n  left: -10000px;\n  will-change: left, top;\n}\n\n/*# sourceMappingURL=Drag.vue.map */"]}, media: undefined });

  };
  /* scoped */
  var __vue_scope_id__$4 = "data-v-7a2f667a";
  /* module identifier */
  var __vue_module_identifier__$4 = "data-v-7a2f667a";
  /* functional template */
...
__vue_render__$3._withStripped = true;
  ...
  var __vue_inject_styles__$3 = function (inject) {
    if (!inject) { return }
    inject("data-v-4cccd9f0_0", { source: ".drop-allowed.drop-in, .drop-allowed.drop-in * {\n  cursor: pointer !important;\n}\n.drop-forbidden.drop-in, .drop-forbidden.drop-in * {\n  cursor: no-drop !important;\n}\n\n/*# sourceMappingURL=Drop.vue.map */", map: {"version":3,"sources":["/Users/lixing/Projects/Easy-DnD/lib/src/components/Drop.vue","Drop.vue"],"names":[],"mappings":"AA+BA;EACA,0BAAA;AC9BA;ADmCA;EACA,0BAAA;AChCA;;AAEA,mCAAmC","file":"Drop.vue","sourcesContent":["<template>\n    <component :is=\"tag\" v-bind=\"$attrs\" v-on=\"$listeners\" :class=\"cssClasses\" :style=\"cssStyle\">\n        <slot></slot>\n        <template v-for=\"(_, slot) of $scopedSlots\" v-slot:[slot]=\"scope\">\n            <slot :name=\"slot\" v-bind=\"scope\"/>\n        </template>\n        <div class=\"__drag-image\" v-if=\"showDragImage\" ref=\"drag-image\">\n            <slot name=\"drag-image\" :type=\"dragType\" :data=\"dragData\"></slot>\n        </div>\n    </component>\n</template>\n\n<script lang=\"ts\">\nimport {Component, Prop} from \"vue-property-decorator\";\nimport DropMixin from \"../mixins/DropMixin\";\n\n@Component({})\nexport default class Drop extends DropMixin {\n\n    @Prop({default: 'div', type: [String, Object, Function]})\n    tag: any;\n\n    get showDragImage() {\n        return this.dragInProgress && this.typeAllowed && this.$scopedSlots['drag-image'];\n    }\n\n}\n</script>\n\n<style lang=\"scss\">\n.drop-allowed.drop-in {\n  &, * {\n    cursor: pointer !important;\n  }\n}\n\n.drop-forbidden.drop-in {\n  &, * {\n    cursor: no-drop !important;\n  }\n}\n</style>\n\n<style lang=\"scss\" scoped>\n/* Places a drag image out of sight while keeping its computed styles accessibles. */\n.__drag-image {\n  position: fixed;\n  top: -10000px;\n  left: -10000px;\n  will-change: left, top;\n}\n</style>",".drop-allowed.drop-in, .drop-allowed.drop-in * {\n  cursor: pointer !important;\n}\n\n.drop-forbidden.drop-in, .drop-forbidden.drop-in * {\n  cursor: no-drop !important;\n}\n\n/*# sourceMappingURL=Drop.vue.map */"]}, media: undefined })
,inject("data-v-4cccd9f0_1", { source: "/* Places a drag image out of sight while keeping its computed styles accessibles. */\n.__drag-image[data-v-4cccd9f0] {\n  position: fixed;\n  top: -10000px;\n  left: -10000px;\n  will-change: left, top;\n}\n\n/*# sourceMappingURL=Drop.vue.map */", map: {"version":3,"sources":["/Users/lixing/Projects/Easy-DnD/lib/src/components/Drop.vue","Drop.vue"],"names":[],"mappings":"AA4CA,oFAAA;AACA;EACA,eAAA;EACA,aAAA;EACA,cAAA;EACA,sBAAA;AC3CA;;AAEA,mCAAmC","file":"Drop.vue","sourcesContent":["<template>\n    <component :is=\"tag\" v-bind=\"$attrs\" v-on=\"$listeners\" :class=\"cssClasses\" :style=\"cssStyle\">\n        <slot></slot>\n        <template v-for=\"(_, slot) of $scopedSlots\" v-slot:[slot]=\"scope\">\n            <slot :name=\"slot\" v-bind=\"scope\"/>\n        </template>\n        <div class=\"__drag-image\" v-if=\"showDragImage\" ref=\"drag-image\">\n            <slot name=\"drag-image\" :type=\"dragType\" :data=\"dragData\"></slot>\n        </div>\n    </component>\n</template>\n\n<script lang=\"ts\">\nimport {Component, Prop} from \"vue-property-decorator\";\nimport DropMixin from \"../mixins/DropMixin\";\n\n@Component({})\nexport default class Drop extends DropMixin {\n\n    @Prop({default: 'div', type: [String, Object, Function]})\n    tag: any;\n\n    get showDragImage() {\n        return this.dragInProgress && this.typeAllowed && this.$scopedSlots['drag-image'];\n    }\n\n}\n</script>\n\n<style lang=\"scss\">\n.drop-allowed.drop-in {\n  &, * {\n    cursor: pointer !important;\n  }\n}\n\n.drop-forbidden.drop-in {\n  &, * {\n    cursor: no-drop !important;\n  }\n}\n</style>\n\n<style lang=\"scss\" scoped>\n/* Places a drag image out of sight while keeping its computed styles accessibles. */\n.__drag-image {\n  position: fixed;\n  top: -10000px;\n  left: -10000px;\n  will-change: left, top;\n}\n</style>","/* Places a drag image out of sight while keeping its computed styles accessibles. */\n.__drag-image {\n  position: fixed;\n  top: -10000px;\n  left: -10000px;\n  will-change: left, top;\n}\n\n/*# sourceMappingURL=Drop.vue.map */"]}, media: undefined });

  };
  /* scoped */
  var __vue_scope_id__$3 = "data-v-4cccd9f0";
  /* module identifier */
  var __vue_module_identifier__$3 = "data-v-4cccd9f0";
  /* functional template */
...
__vue_render__$2._withStripped = true;
  ...
  /* module identifier */
  var __vue_module_identifier__$2 = "data-v-1ac33126";
  /* functional template */
