...
var DragMixin = /** @class */ (function (_super) {
    ...
    __decorate([
        vuePropertyDecorator.Prop({ default: options['drag.dragImageOpacity'], type: Number }),
        __metadata("design:type", Object)
    ...
    __decorate([
        vuePropertyDecorator.Prop({ default: options['drag.goBack'], type: Boolean }),
        __metadata("design:type", Boolean)
    ], DragMixin.prototype, "goBack", void 0);
    __decorate([
        vuePropertyDecorator.Prop({ default: options['drag.handle'], required: false, type: String }),
        __metadata("design:type", String)
    ], DragMixin.prototype, "handle", void 0);
    __decorate([
        vuePropertyDecorator.Prop({ type: Number, default: options['drag.delta'] }),
        __metadata("design:type", Number)
    ], DragMixin.prototype, "delta", void 0);
    __decorate([
        vuePropertyDecorator.Prop({ type: Number, default: options['drag.delay'] }),
        __metadata("design:type", Number)
    ], DragMixin.prototype, "delay", void 0);
    __decorate([
        vuePropertyDecorator.Prop({ type: String, default: options['drag.dragClass'] }),
        __metadata("design:type", String)
    ], DragMixin.prototype, "dragClass", void 0);
    __decorate([
        vuePropertyDecorator.Prop({ type: Number, default: options['drag.vibration'] }),
        __metadata("design:type", Number)
    ], DragMixin.prototype, "vibration", void 0);
    __decorate([
        vuePropertyDecorator.Prop({ type: Number, default: options['drag.scrollingEdgeSize'] }),
        __metadata("design:type", Number)
...
,inject("data-v-1e7ee26e_2", { source: ".__drag-image[data-v-1e7ee26e]{position:fixed;top:-10000px;left:-10000px;will-change:left,top}", map: undefined, media: undefined });
  ...
  /* module identifier */
  var __vue_module_identifier__ = "data-v-1e7ee26e";
  /* functional template */
...
var DropMixin = /** @class */ (function (_super) {
    ...
    __decorate([
        vuePropertyDecorator.Prop({ default: options['drop.mode'] }),
        __metadata("design:type", String)
    ], DropMixin.prototype, "mode", void 0);
    __decorate([
        vuePropertyDecorator.Prop({ default: options['drop.dragImageOpacity'], type: Number }),
        __metadata("design:type", Object)
...
,inject("data-v-36a3fb0c_1", { source: ".__drag-image[data-v-36a3fb0c]{position:fixed;top:-10000px;left:-10000px;will-change:left,top}", map: undefined, media: undefined });
  ...
  /* module identifier */
  var __vue_module_identifier__$1 = "data-v-36a3fb0c";
  /* functional template */
...
var DropList = /** @class */ (function (_super) {
    ...
    __decorate([
        vuePropertyDecorator.Prop({ default: options['components.dropList.noAnimations'], type: Boolean }),
        __metadata("design:type", Boolean)
    ], DropList.prototype, "noAnimations", void 0);
    __decorate([
        vuePropertyDecorator.Prop({ type: Number, default: options['components.dropList.scrollingEdgeSize'] }),
        __metadata("design:type", Number)
...
var __vue_staticRenderFns__$4 = [];
  ...
  var __vue_inject_styles__$4 = function (inject) {
    if (!inject) { return }
    inject("data-v-7bf63fd0_0", { source: ".drop-list[data-v-7bf63fd0]>*{transition:transform .2s}.__feedback[data-v-7bf63fd0]{display:none}.__drag-image[data-v-7bf63fd0]{position:fixed;top:-10000px;left:-10000px;will-change:left,top}", map: undefined, media: undefined })
,inject("data-v-7bf63fd0_1", { source: ".drop-allowed.drop-in *{cursor:inherit!important}.drop-forbidden.drop-in,.drop-forbidden.drop-in *{cursor:no-drop!important}", map: undefined, media: undefined });

  };
  /* scoped */
  var __vue_scope_id__$4 = "data-v-7bf63fd0";
  /* module identifier */
  var __vue_module_identifier__$4 = "data-v-7bf63fd0";
  /* functional template */
