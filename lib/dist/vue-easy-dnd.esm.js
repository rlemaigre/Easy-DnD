...
var __vue_staticRenderFns__$4 = [];
  ...
  var __vue_inject_styles__$4 = function (inject) {
    if (!inject) { return }
    inject("data-v-e3e015da_0", { source: ".drop-list[data-v-e3e015da]>*{transition:transform .2s}.feedback[data-v-e3e015da]{display:none}.__drag-image[data-v-e3e015da]{position:fixed;top:-10000px;left:-10000px;will-change:left,top}", map: undefined, media: undefined })
,inject("data-v-e3e015da_1", { source: ".drop-allowed.drop-in *{cursor:inherit!important}.drop-forbidden.drop-in,.drop-forbidden.drop-in *{cursor:no-drop!important}", map: undefined, media: undefined });

  };
  /* scoped */
  var __vue_scope_id__$4 = "data-v-e3e015da";
  /* module identifier */
