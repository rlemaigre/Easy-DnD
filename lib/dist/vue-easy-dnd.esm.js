...
/* template */
var __vue_render__$4 = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('transition-group',{ref:"tg",class:_vm.clazz,style:(_vm.cssStyle),attrs:{"tag":_vm.tag,"name":"drop-list-transition","duration":{enter: 0, leave: 0},"css":false}},[_vm._l((_vm.itemsBeforeFeedback),function(item){return _vm._t("item",null,{"item":item})}),_vm._v(" "),(_vm.closestIndex !== null && !_vm.reordering)?_vm._t("feedback",null,{"data":_vm.dragData,"type":_vm.dragType}):_vm._e(),_vm._v(" "),_vm._l((_vm.itemsAfterFeedback),function(item){return _vm._t("item",null,{"item":item})}),_vm._v(" "),_vm._l((_vm.reorderedItems),function(item,index){return _vm._t("item",null,{"item":item,"reorder":index === _vm.closestIndex})}),_vm._v(" "),(_vm.showFeedback)?_c('drag-feedback',{key:"drag-feedback",ref:"feedback",staticClass:"feedback"},[_vm._t("feedback",null,{"data":_vm.dragData,"type":_vm.dragType})],2):_vm._e(),_vm._v(" "),(_vm.showDragImage)?_c('div',{key:"drag-image",ref:"drag-image",staticClass:"__drag-image"},[_vm._t("drag-image",null,{"type":_vm.dragType,"data":_vm.dragData,"reorder":_vm.reordering})],2):_vm._e()],2)};
var __vue_staticRenderFns__$4 = [];

  /* style */
  var __vue_inject_styles__$4 = function (inject) {
    if (!inject) { return }
    inject("data-v-b393c8f4_0", { source: ".tg[data-v-b393c8f4]>*{transition:transform .2s}.feedback[data-v-b393c8f4]{display:none}.__drag-image[data-v-b393c8f4]{position:fixed;top:-10000px;left:-10000px;will-change:left,top}", map: undefined, media: undefined })
,inject("data-v-b393c8f4_1", { source: ".drop-allowed.drop-in *{cursor:inherit!important}.drop-forbidden.drop-in,.drop-forbidden.drop-in *{cursor:no-drop!important}", map: undefined, media: undefined });

  };
  /* scoped */
  var __vue_scope_id__$4 = "data-v-b393c8f4";
  /* module identifier */
