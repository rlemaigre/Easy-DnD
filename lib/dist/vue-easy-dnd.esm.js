...
DnD.prototype.emit = function emit(event, data) {
    this.eventBus.$emit(event, Object.assign({}, {
            type: this.type,
            data: this.data,
            top: this.top,
            source: this.source,
...
var DragAwareMixin = /*@__PURE__*/(function (Vue) {
    ...
    var prototypeAccessors = {
        dragInProgress: {configurable: true},
        dragData: {configurable: true},
        dragType: {configurable: true},
        dragPosition: {configurable: true},
        dragSource: {configurable: true},
        dragTop: {configurable: true}
    };
...
var DragMixin = /*@__PURE__*/(function (DragAwareMixin) {
    ...
    var prototypeAccessors = {
        dragIn: {configurable: true},
        cssClasses: {configurable: true},
        currentDropMode: {configurable: true}
    };
    DragMixin.prototype.created = function created() {
        var this$1 = this;

        dnd.on("dragstart", function (event) {
            return this$1.$emit("dragstart", event);
        });
        dnd.on("dragend", function (event) {
            return this$1.$emit("dragend", event);
        });
    };
...
var __vue_render__ = function () {
    ...
    return _c(_vm.tag, _vm._g(_vm._b({
        ...
        style: ({cursor: _vm.disabled || _vm.handle ? null : 'grab'}),
        scopedSlots: _vm._u([_vm._l((_vm.$scopedSlots), function (_, slot) {
            return {
                key: slot, fn: function (scope) {
                    return [_vm._t(slot, null, null, scope)]
                }
            }
        })], null, true)
    }, 'component', _vm.$attrs, false), _vm.$listeners), [_vm._t("default"), _vm._v(" "), _vm._v(" "), _c('div', {
        ref: "drag-image",
        staticClass: "__drag-image"
    }, [_vm._t("drag-image")], 2)], 2)
};
...
var __vue_inject_styles__ = function (inject) {
    ...
    inject("data-v-4ce62e8b_0", {
        source: ".drop-allowed.drop-in *{cursor:inherit!important}.drop-forbidden.drop-in,.drop-forbidden.drop-in *{cursor:no-drop!important}",
        map: undefined,
        media: undefined
    })
        , inject("data-v-4ce62e8b_1", {
        source: "html.drag-in-progress *{cursor:grabbing!important}",
        map: undefined,
        media: undefined
    })
        , inject("data-v-4ce62e8b_2", {
        source: ".__drag-image[data-v-4ce62e8b]{position:fixed;top:-10000px;left:-10000px;will-change:left,top}",
        map: undefined,
        media: undefined
    });
...
var DropMixin = /*@__PURE__*/(function (DragAwareMixin) {
    ...
    var prototypeAccessors = {
        compatibleMode: {configurable: true},
        dropIn: {configurable: true},
        typeAllowed: {configurable: true},
        dropAllowed: {configurable: true},
        cssClasses: {configurable: true},
        cssStyle: {configurable: true}
    };
...
var __vue_render__$1 = function () {
    ...
    }, 'component', _vm.$attrs, false), _vm.$listeners), [_vm._t("default"), _vm._v(" "), _vm._v(" "), (_vm.showDragImage) ? _c('div', {
        ref: "drag-image",
        staticClass: "__drag-image"
    }, [_vm._t("drag-image", null, {"type": _vm.dragType, "data": _vm.dragData})], 2) : _vm._e()], 2)
};
...
var __vue_inject_styles__$1 = function (inject) {
    ...
    inject("data-v-755d0872_0", {
        source: ".drop-allowed.drop-in *{cursor:inherit!important}.drop-forbidden.drop-in,.drop-forbidden.drop-in *{cursor:no-drop!important}",
        map: undefined,
        media: undefined
    })
        , inject("data-v-755d0872_1", {
        source: ".__drag-image[data-v-755d0872]{position:fixed;top:-10000px;left:-10000px;will-change:left,top}",
        map: undefined,
        media: undefined
    });
...
var Grid = function Grid(collection, upToIndex) {
    this.magnets = [];
    var index = 0;
...
var DropList = /*@__PURE__*/(function (DropMixin) {
    ...
    var prototypeAccessors = {
        reordering: {configurable: true},
        closestIndex: {configurable: true},
        dropAllowed: {configurable: true},
        itemsBeforeFeedback: {configurable: true},
        itemsAfterFeedback: {configurable: true},
        reorderedItems: {configurable: true},
        clazz: {configurable: true},
        style: {configurable: true},
        showDragFeedback: {configurable: true},
        showInsertingDragImage: {configurable: true},
        showReorderingDragImage: {configurable: true}
    };
    ...
    DropList.prototype.computeInsertingGrid = function computeInsertingGrid() {
        ...
        var grid = new Grid(tg.children, this.items.length);
        clone.remove();
        return grid;
    };
...
var __vue_render__$4 = function () {
    ...
    return _c('transition-group', {
    ...
    }, [(_vm.dropIn && _vm.dropAllowed) ? [(_vm.reordering) ? [_vm._l((_vm.reorderedItems), function (item, index) {
        return _vm._t("item", null, {"item": item, "reorder": index === _vm.closestIndex})
    })] : [_vm._l((_vm.itemsBeforeFeedback), function (item) {
        return _vm._t("item", null, {"item": item, "reorder": false})
    }), _vm._v(" "), _vm._t("feedback", null, {
        "data": _vm.dragData,
        "type": _vm.dragType
    }), _vm._v(" "), _vm._l((_vm.itemsAfterFeedback), function (item) {
        return _vm._t("item", null, {"item": item, "reorder": false})
    })]] : [_vm._l((_vm.items), function (item) {
        return _vm._t("item", null, {"item": item, "reorder": false})
    })], _vm._v(" "), (_vm.showDragFeedback) ? _c('drag-feedback', {
        key: "drag-feedback",
        ref: "feedback",
        ...
        "data": _vm.dragData,
        "type": _vm.dragType
    })], 2) : _vm._e(), _vm._v(" "), (_vm.showInsertingDragImage) ? _c('div', {
        ...
        "type": _vm.dragType,
        "data": _vm.dragData
    })], 2) : _vm._e(), _vm._v(" "), (_vm.showReorderingDragImage) ? _c('div', {
        key: "reordering-drag-image",
        ref: "drag-image",
        staticClass: "__drag-image"
    }, [_vm._t("reordering-drag-image", null, {"item": _vm.items[_vm.fromIndex]})], 2) : _vm._e(), _vm._v(" "), _c('div', {key: "drop-list-content"}, [_vm._t("default")], 2)], 2)
};
...
var __vue_inject_styles__$4 = function (inject) {
    ...
    inject("data-v-4daf276f_0", {
        source: ".drag-in-progress .drop-list[data-v-4daf276f]>*{transition:transform .2s}.feedback[data-v-4daf276f]{display:none}.__drag-image[data-v-4daf276f]{position:fixed;top:-10000px;left:-10000px;will-change:left,top}",
        map: undefined,
        media: undefined
    })
        , inject("data-v-4daf276f_1", {
        source: ".drop-allowed.drop-in *{cursor:inherit!important}.drop-forbidden.drop-in,.drop-forbidden.drop-in *{cursor:no-drop!important}",
        map: undefined,
        media: undefined
    });
...
/* scoped */
var __vue_scope_id__$4 = "data-v-4daf276f";
/* module identifier */
...
export {
    DnDEvent,
    Drag$1 as Drag,
    DragAwareMixin$1 as DragAwareMixin,
    DragImagesManager,
    DragMixin$1 as DragMixin,
    Drop$1 as Drop,
    DropList$1 as DropList,
    DropMask$1 as DropMask,
    DropMixin$1 as DropMixin,
    InsertEvent,
    ReorderEvent,
    createDragImage,
    dnd
