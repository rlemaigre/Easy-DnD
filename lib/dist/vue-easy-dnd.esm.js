...
var __vue_staticRenderFns__$4 = [];
  ...
  var __vue_inject_styles__$4 = function (inject) {
    if (!inject) { return }
    inject("data-v-3f0dc842_0", { source: ".drop-list[data-v-3f0dc842]>*{transition:transform .2s}.feedback[data-v-3f0dc842]{display:none}.__drag-image[data-v-3f0dc842]{position:fixed;top:-10000px;left:-10000px;will-change:left,top}.drop-list[data-v-3f0dc842]:not(.drop-in) .drag-source{transition:none!important}", map: undefined, media: undefined })
,inject("data-v-3f0dc842_1", { source: ".drop-allowed.drop-in *{cursor:inherit!important}.drop-forbidden.drop-in,.drop-forbidden.drop-in *{cursor:no-drop!important}", map: undefined, media: undefined });

  };
  /* scoped */
  var __vue_scope_id__$4 = "data-v-3f0dc842";
  /* module identifier */
