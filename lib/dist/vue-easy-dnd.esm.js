...
DnD.prototype.mouseEnter = function mouseEnter (enter, event) {
    /*
...
DnD.prototype.mouseLeave = function mouseLeave (leave, event) {
    /*
     * The condition e.relatedTarget !== null is a fix for firefox triggering the mouseenter event several times. The
     * wrong events have a null relatedTarget in FF.
     */
...
DnD.prototype.emit = function emit (event, data) {
      ...
      _vm._b(
        {
          ...
          style: { cursor: _vm.disabled ? null : "grab" },
          scopedSlots: _vm._u(
            [
...
__vue_render__._withStripped = true;
  ...
  var __vue_inject_styles__ = function (inject) {
    if (!inject) { return }
    inject("data-v-39edf520_0", { source: ".drop-allowed.drop-in * {\n  cursor: inherit !important;\n}\n.drop-forbidden.drop-in, .drop-forbidden.drop-in * {\n  cursor: no-drop !important;\n}\n\n/*# sourceMappingURL=Drag.vue.map */", map: {"version":3,"sources":["D:\\Projects\\Easy-DnD\\lib\\src\\components\\Drag.vue","Drag.vue"],"names":[],"mappings":"AA8BA;EACA,0BAAA;AC7BA;ADiCA;EACA,0BAAA;AC9BA;;AAEA,mCAAmC","file":"Drag.vue","sourcesContent":["<template>\n    <component :is=\"tag\" v-bind=\"$attrs\" v-on=\"$listeners\" :style=\"{cursor: disabled ? null : 'grab'}\"\n               :class=\"cssClasses\">\n        <slot></slot>\n        <template v-for=\"(_, slot) of $scopedSlots\" v-slot:[slot]=\"scope\">\n            <slot :name=\"slot\" v-bind=\"scope\"/>\n        </template>\n        <div class=\"__drag-image\" ref=\"drag-image\">\n            <slot name=\"drag-image\"></slot>\n        </div>\n    </component>\n</template>\n\n<script lang=\"ts\">\n    import {Component, Prop} from \"vue-property-decorator\";\n    import DragMixin from \"../mixins/DragMixin\";\n\n    @Component({})\n    export default class Drag extends DragMixin {\n\n        /**\n         * Tag to be used as root of this component. Defaults to div.\n         */\n        @Prop({default: 'div', type: [String, Object]})\n        tag: string | object;\n\n    }\n</script>\n\n<style lang=\"scss\">\n    .drop-allowed.drop-in * {\n        cursor: inherit !important;\n    }\n\n    .drop-forbidden.drop-in {\n        &, * {\n            cursor: no-drop !important;\n        }\n    }\n</style>\n\n<style lang=\"scss\">\n    html.drag-in-progress * {\n        cursor: grabbing !important;\n    }\n</style>\n\n<style lang=\"scss\" scoped>\n    /* Places a drag image out of sight while keeping its computed styles accessibles. */\n    .__drag-image {\n        position: fixed;\n        top: -10000px;\n        left: -10000px;\n        will-change: left, top;\n    }\n</style>",".drop-allowed.drop-in * {\n  cursor: inherit !important;\n}\n\n.drop-forbidden.drop-in, .drop-forbidden.drop-in * {\n  cursor: no-drop !important;\n}\n\n/*# sourceMappingURL=Drag.vue.map */"]}, media: undefined })
,inject("data-v-39edf520_1", { source: "html.drag-in-progress * {\n  cursor: grabbing !important;\n}\n\n/*# sourceMappingURL=Drag.vue.map */", map: {"version":3,"sources":["D:\\Projects\\Easy-DnD\\lib\\src\\components\\Drag.vue","Drag.vue"],"names":[],"mappings":"AA0CA;EACA,2BAAA;ACzCA;;AAEA,mCAAmC","file":"Drag.vue","sourcesContent":["<template>\n    <component :is=\"tag\" v-bind=\"$attrs\" v-on=\"$listeners\" :style=\"{cursor: disabled ? null : 'grab'}\"\n               :class=\"cssClasses\">\n        <slot></slot>\n        <template v-for=\"(_, slot) of $scopedSlots\" v-slot:[slot]=\"scope\">\n            <slot :name=\"slot\" v-bind=\"scope\"/>\n        </template>\n        <div class=\"__drag-image\" ref=\"drag-image\">\n            <slot name=\"drag-image\"></slot>\n        </div>\n    </component>\n</template>\n\n<script lang=\"ts\">\n    import {Component, Prop} from \"vue-property-decorator\";\n    import DragMixin from \"../mixins/DragMixin\";\n\n    @Component({})\n    export default class Drag extends DragMixin {\n\n        /**\n         * Tag to be used as root of this component. Defaults to div.\n         */\n        @Prop({default: 'div', type: [String, Object]})\n        tag: string | object;\n\n    }\n</script>\n\n<style lang=\"scss\">\n    .drop-allowed.drop-in * {\n        cursor: inherit !important;\n    }\n\n    .drop-forbidden.drop-in {\n        &, * {\n            cursor: no-drop !important;\n        }\n    }\n</style>\n\n<style lang=\"scss\">\n    html.drag-in-progress * {\n        cursor: grabbing !important;\n    }\n</style>\n\n<style lang=\"scss\" scoped>\n    /* Places a drag image out of sight while keeping its computed styles accessibles. */\n    .__drag-image {\n        position: fixed;\n        top: -10000px;\n        left: -10000px;\n        will-change: left, top;\n    }\n</style>","html.drag-in-progress * {\n  cursor: grabbing !important;\n}\n\n/*# sourceMappingURL=Drag.vue.map */"]}, media: undefined })
,inject("data-v-39edf520_2", { source: "/* Places a drag image out of sight while keeping its computed styles accessibles. */\n.__drag-image[data-v-39edf520] {\n  position: fixed;\n  top: -10000px;\n  left: -10000px;\n  will-change: left, top;\n}\n\n/*# sourceMappingURL=Drag.vue.map */", map: {"version":3,"sources":["D:\\Projects\\Easy-DnD\\lib\\src\\components\\Drag.vue","Drag.vue"],"names":[],"mappings":"AAgDA,oFAAA;AACA;EACA,eAAA;EACA,aAAA;EACA,cAAA;EACA,sBAAA;AC/CA;;AAEA,mCAAmC","file":"Drag.vue","sourcesContent":["<template>\n    <component :is=\"tag\" v-bind=\"$attrs\" v-on=\"$listeners\" :style=\"{cursor: disabled ? null : 'grab'}\"\n               :class=\"cssClasses\">\n        <slot></slot>\n        <template v-for=\"(_, slot) of $scopedSlots\" v-slot:[slot]=\"scope\">\n            <slot :name=\"slot\" v-bind=\"scope\"/>\n        </template>\n        <div class=\"__drag-image\" ref=\"drag-image\">\n            <slot name=\"drag-image\"></slot>\n        </div>\n    </component>\n</template>\n\n<script lang=\"ts\">\n    import {Component, Prop} from \"vue-property-decorator\";\n    import DragMixin from \"../mixins/DragMixin\";\n\n    @Component({})\n    export default class Drag extends DragMixin {\n\n        /**\n         * Tag to be used as root of this component. Defaults to div.\n         */\n        @Prop({default: 'div', type: [String, Object]})\n        tag: string | object;\n\n    }\n</script>\n\n<style lang=\"scss\">\n    .drop-allowed.drop-in * {\n        cursor: inherit !important;\n    }\n\n    .drop-forbidden.drop-in {\n        &, * {\n            cursor: no-drop !important;\n        }\n    }\n</style>\n\n<style lang=\"scss\">\n    html.drag-in-progress * {\n        cursor: grabbing !important;\n    }\n</style>\n\n<style lang=\"scss\" scoped>\n    /* Places a drag image out of sight while keeping its computed styles accessibles. */\n    .__drag-image {\n        position: fixed;\n        top: -10000px;\n        left: -10000px;\n        will-change: left, top;\n    }\n</style>","/* Places a drag image out of sight while keeping its computed styles accessibles. */\n.__drag-image {\n  position: fixed;\n  top: -10000px;\n  left: -10000px;\n  will-change: left, top;\n}\n\n/*# sourceMappingURL=Drag.vue.map */"]}, media: undefined });

  };
  /* scoped */
  var __vue_scope_id__ = "data-v-39edf520";
  /* module identifier */
...
__vue_render__$1._withStripped = true;
  ...
  var __vue_inject_styles__$1 = function (inject) {
    if (!inject) { return }
    inject("data-v-c75e3282_0", { source: ".drop-allowed.drop-in * {\n  cursor: inherit !important;\n}\n.drop-forbidden.drop-in, .drop-forbidden.drop-in * {\n  cursor: no-drop !important;\n}\n\n/*# sourceMappingURL=Drop.vue.map */", map: {"version":3,"sources":["D:\\Projects\\Easy-DnD\\lib\\src\\components\\Drop.vue","Drop.vue"],"names":[],"mappings":"AA8BA;EACA,0BAAA;AC7BA;ADiCA;EACA,0BAAA;AC9BA;;AAEA,mCAAmC","file":"Drop.vue","sourcesContent":["<template>\n    <component :is=\"tag\" v-bind=\"$attrs\" v-on=\"$listeners\" :class=\"cssClasses\" :style=\"cssStyle\">\n        <slot></slot>\n        <template v-for=\"(_, slot) of $scopedSlots\" v-slot:[slot]=\"scope\">\n            <slot :name=\"slot\" v-bind=\"scope\"/>\n        </template>\n        <div class=\"__drag-image\" v-if=\"showDragImage\" ref=\"drag-image\">\n            <slot name=\"drag-image\" :type=\"dragType\" :data=\"dragData\"></slot>\n        </div>\n    </component>\n</template>\n\n<script lang=\"ts\">\n    import {Component, Prop} from \"vue-property-decorator\";\n    import DropMixin from \"../mixins/DropMixin\";\n\n    @Component({})\n    export default class Drop extends DropMixin {\n\n        @Prop({default: 'div', type: [String, Object]})\n        tag: string | object;\n\n        get showDragImage() {\n            return this.dragInProgress && this.typeAllowed && this.$scopedSlots['drag-image'];\n        }\n\n    }\n</script>\n\n<style lang=\"scss\">\n    .drop-allowed.drop-in * {\n        cursor: inherit !important;\n    }\n\n    .drop-forbidden.drop-in {\n        &, * {\n            cursor: no-drop !important;\n        }\n    }\n</style>\n\n<style lang=\"scss\" scoped>\n    /* Places a drag image out of sight while keeping its computed styles accessibles. */\n    .__drag-image {\n        position: fixed;\n        top: -10000px;\n        left: -10000px;\n        will-change: left, top;\n    }\n</style>",".drop-allowed.drop-in * {\n  cursor: inherit !important;\n}\n\n.drop-forbidden.drop-in, .drop-forbidden.drop-in * {\n  cursor: no-drop !important;\n}\n\n/*# sourceMappingURL=Drop.vue.map */"]}, media: undefined })
,inject("data-v-c75e3282_1", { source: "/* Places a drag image out of sight while keeping its computed styles accessibles. */\n.__drag-image[data-v-c75e3282] {\n  position: fixed;\n  top: -10000px;\n  left: -10000px;\n  will-change: left, top;\n}\n\n/*# sourceMappingURL=Drop.vue.map */", map: {"version":3,"sources":["D:\\Projects\\Easy-DnD\\lib\\src\\components\\Drop.vue","Drop.vue"],"names":[],"mappings":"AA0CA,oFAAA;AACA;EACA,eAAA;EACA,aAAA;EACA,cAAA;EACA,sBAAA;ACzCA;;AAEA,mCAAmC","file":"Drop.vue","sourcesContent":["<template>\n    <component :is=\"tag\" v-bind=\"$attrs\" v-on=\"$listeners\" :class=\"cssClasses\" :style=\"cssStyle\">\n        <slot></slot>\n        <template v-for=\"(_, slot) of $scopedSlots\" v-slot:[slot]=\"scope\">\n            <slot :name=\"slot\" v-bind=\"scope\"/>\n        </template>\n        <div class=\"__drag-image\" v-if=\"showDragImage\" ref=\"drag-image\">\n            <slot name=\"drag-image\" :type=\"dragType\" :data=\"dragData\"></slot>\n        </div>\n    </component>\n</template>\n\n<script lang=\"ts\">\n    import {Component, Prop} from \"vue-property-decorator\";\n    import DropMixin from \"../mixins/DropMixin\";\n\n    @Component({})\n    export default class Drop extends DropMixin {\n\n        @Prop({default: 'div', type: [String, Object]})\n        tag: string | object;\n\n        get showDragImage() {\n            return this.dragInProgress && this.typeAllowed && this.$scopedSlots['drag-image'];\n        }\n\n    }\n</script>\n\n<style lang=\"scss\">\n    .drop-allowed.drop-in * {\n        cursor: inherit !important;\n    }\n\n    .drop-forbidden.drop-in {\n        &, * {\n            cursor: no-drop !important;\n        }\n    }\n</style>\n\n<style lang=\"scss\" scoped>\n    /* Places a drag image out of sight while keeping its computed styles accessibles. */\n    .__drag-image {\n        position: fixed;\n        top: -10000px;\n        left: -10000px;\n        will-change: left, top;\n    }\n</style>","/* Places a drag image out of sight while keeping its computed styles accessibles. */\n.__drag-image {\n  position: fixed;\n  top: -10000px;\n  left: -10000px;\n  will-change: left, top;\n}\n\n/*# sourceMappingURL=Drop.vue.map */"]}, media: undefined });

  };
  /* scoped */
  var __vue_scope_id__$1 = "data-v-c75e3282";
  /* module identifier */
...
var Grid = function Grid(collection) {
    this.centers = [];
...
Grid.prototype.closestIndex = function closestIndex (position) {
    ...
    for (var i = 0; i < this.centers.length; i++) {
        ...
        var dist = Math.sqrt(Math.pow(center.x - position.x, 2) + Math.pow(center.y - position.y, 2));
        if (dist < minDist) {
            minDist = dist;
            index = i;
        }
...
var DropList = /*@__PURE__*/(function (DropMixin) {
    ...
    var prototypeAccessors = { reordering: { configurable: true },closestIndex: { configurable: true },dropAllowed: { configurable: true },itemsBeforeFeedback: { configurable: true },itemsAfterFeedback: { configurable: true },reorderedItems: { configurable: true },clazz: { configurable: true },style: { configurable: true },showDragFeedback: { configurable: true },showInsertingDragImage: { configurable: true },showReorderingDragImage: { configurable: true } };
    ...
    DropList.prototype.candidate = function candidate () {
        var superCandidate = DropMixin['options'].methods.candidate.call(this);
...
var __vue_render__$4 = function() {
  ...
  return _c(
    "transition-group",
    {
      ...
      class: _vm.clazz,
      style: _vm.style,
      attrs: { tag: _vm.tag, duration: { enter: 0, leave: 0 }, css: false }
    },
    [
      ...
      _vm.showDragFeedback
        ? _c(
            "drag-feedback",
            { key: "drag-feedback", ref: "feedback", staticClass: "feedback" },
            [
              _vm._t("feedback", null, {
                data: _vm.dragData,
                type: _vm.dragType
