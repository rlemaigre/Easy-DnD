...
/* template */
var __vue_render__ = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c(_vm.tag,_vm._g(_vm._b({tag:"component",class:_vm.cssClasses,style:({cursor: 'grab'}),scopedSlots:_vm._u([_vm._l((_vm.$scopedSlots),function(_,slot){return {key:slot,fn:function(scope){return [_vm._t(slot,null,null,scope)]}}})],null,true)},'component',_vm.$attrs,false),_vm.$listeners),[_vm._t("default"),_vm._v(" "),_vm._v(" "),(_vm.showDragImage)?_c('div',{ref:"drag-image",staticClass:"__drag-image"},[_vm._t("drag-image")],2):_vm._e()],2)};
var __vue_staticRenderFns__ = [];

  /* style */
  var __vue_inject_styles__ = function (inject) {
    if (!inject) { return }
    inject("data-v-8bd69228_0", { source: ".drop-allowed.drop-in *{cursor:inherit!important}.drop-forbidden.drop-in,.drop-forbidden.drop-in *{cursor:no-drop!important}", map: undefined, media: undefined })
,inject("data-v-8bd69228_1", { source: "html.drag-in-progress *{cursor:grabbing!important}", map: undefined, media: undefined })
,inject("data-v-8bd69228_2", { source: ".__drag-image[data-v-8bd69228]{position:fixed;top:-10000px;left:-10000px;will-change:left,top}", map: undefined, media: undefined });

  };
  /* scoped */
  var __vue_scope_id__ = "data-v-8bd69228";
  /* module identifier */
...
var DragImagesManager = /*@__PURE__*/(function (Vue) {
    ...
    DragImagesManager.prototype.onDragTopChanged = function onDragTopChanged (event) {
        ...
        Vue.nextTick(function () {
            ...
            if (this$1.sourceClone) {
                this$1.sourceClone.style.opacity = "0";
            }
            var activeClone;
            if (top === null) {
                activeClone = this$1.getSourceClone();
            }
            else {
                if (!this$1.clones.has(top)) {
                    var clone = top['createDragImage'](this$1.selfTransform);
                    if (clone === 'source') {
                        clone = this$1.getSourceClone();
                    }
                    else if (clone !== null) {
                        clone.style.opacity = '0';
                        document.body.append(clone);
                    }
                    this$1.clones.set(top, clone);
                }
                activeClone = this$1.clones.get(top);
            }
            if (activeClone !== null) {
...
function reorder(array, event) {
    var tmp = array[event.from];
    array.splice(event.from, 1);
    array.splice(event.to, 0, tmp);
}

export { DnDEvent, Drag$1 as Drag, DragAwareMixin$1 as DragAwareMixin, DragImagesManager, DragMixin$1 as DragMixin, Drop$1 as Drop, DropList$1 as DropList, DropMask$1 as DropMask, DropMixin$1 as DropMixin, InsertEvent, ReorderEvent, createDragImage, dnd, reorder };
