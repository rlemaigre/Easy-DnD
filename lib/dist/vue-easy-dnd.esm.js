...
DnD.prototype.stopDrag = function stopDrag () {
    ...
    setTimeout(function () {
        this$1.inProgress = false;
        this$1.data = null;
        this$1.source = null;
        this$1.stack = null;
        this$1.position = null;
    }, 0);
};
...
/* template */
var __vue_render__ = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c(_vm.tag,_vm._g(_vm._b({tag:"component",class:_vm.cssClasses,style:({cursor: _vm.disabled ? null : 'grab'}),scopedSlots:_vm._u([_vm._l((_vm.$scopedSlots),function(_,slot){return {key:slot,fn:function(scope){return [_vm._t(slot,null,null,scope)]}}})],null,true)},'component',_vm.$attrs,false),_vm.$listeners),[_vm._t("default"),_vm._v(" "),_vm._v(" "),_c('div',{ref:"drag-image",staticClass:"__drag-image"},[_vm._t("drag-image")],2)],2)};
var __vue_staticRenderFns__ = [];

  /* style */
  var __vue_inject_styles__ = function (inject) {
    if (!inject) { return }
    inject("data-v-3c7acea3_0", { source: ".drop-allowed.drop-in *{cursor:inherit!important}.drop-forbidden.drop-in,.drop-forbidden.drop-in *{cursor:no-drop!important}", map: undefined, media: undefined })
,inject("data-v-3c7acea3_1", { source: "html.drag-in-progress *{cursor:grabbing!important}", map: undefined, media: undefined })
,inject("data-v-3c7acea3_2", { source: ".__drag-image[data-v-3c7acea3]{position:fixed;top:-10000px;left:-10000px;will-change:left,top}", map: undefined, media: undefined });

  };
  /* scoped */
  var __vue_scope_id__ = "data-v-3c7acea3";
  /* module identifier */
...
var __vue_staticRenderFns__$4 = [];
  ...
  var __vue_inject_styles__$4 = function (inject) {
    if (!inject) { return }
    inject("data-v-581894f4_0", { source: ".drag-in-progress .drop-list[data-v-581894f4]>*{transition:transform .2s}.feedback[data-v-581894f4]{display:none}.__drag-image[data-v-581894f4]{position:fixed;top:-10000px;left:-10000px;will-change:left,top}.drop-list[data-v-581894f4]:not(.drop-in) .drag-source{transition:none!important}", map: undefined, media: undefined })
,inject("data-v-581894f4_1", { source: ".drop-allowed.drop-in *{cursor:inherit!important}.drop-forbidden.drop-in,.drop-forbidden.drop-in *{cursor:no-drop!important}", map: undefined, media: undefined });

  };
  /* scoped */
  var __vue_scope_id__$4 = "data-v-581894f4";
  /* module identifier */
