...
var __vue_staticRenderFns__$4 = [];
  ...
  var __vue_inject_styles__$4 = function (inject) {
    if (!inject) { return }
    inject("data-v-4daf276f_0", { source: ".drag-in-progress .drop-list[data-v-4daf276f]>*{transition:transform .2s}.feedback[data-v-4daf276f]{display:none}.__drag-image[data-v-4daf276f]{position:fixed;top:-10000px;left:-10000px;will-change:left,top}", map: undefined, media: undefined })
,inject("data-v-4daf276f_1", { source: ".drop-allowed.drop-in *{cursor:inherit!important}.drop-forbidden.drop-in,.drop-forbidden.drop-in *{cursor:no-drop!important}", map: undefined, media: undefined });
