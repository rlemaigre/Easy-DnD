...
var DragMixin = /*@__PURE__*/(function (Vue) {
    function DragMixin() {
    ...
    if ( Vue ) DragMixin.__proto__ = Vue;
    DragMixin.prototype = Object.create( Vue && Vue.prototype );
...
var Drag = /*@__PURE__*/(function (DragMixin) {
    ...
    var prototypeAccessors = { showDragImage: { configurable: true },dndtype: { configurable: true },dnddata: { configurable: true },clazz: { configurable: true } };
...
var __vue_staticRenderFns__ = [];
  ...
  var __vue_inject_styles__ = function (inject) {
    if (!inject) { return }
    inject("data-v-712e2375_0", { source: "", map: undefined, media: undefined })
,inject("data-v-712e2375_1", { source: "html.drag-in-progress *{cursor:grabbing!important}.drag-image{position:fixed;top:-10000px;left:-10000px;will-change:left,top}", map: undefined, media: undefined });

  };
  /* scoped */
  var __vue_scope_id__ = "data-v-712e2375";
  /* module identifier */
...
var __vue_staticRenderFns__$1 = [];
  ...
  var __vue_inject_styles__$1 = function (inject) {
    if (!inject) { return }
    inject("data-v-d89680ea_0", { source: ".drop-allowed.drop-in *{cursor:inherit!important}.drop-forbidden.drop-in,.drop-forbidden.drop-in *{cursor:no-drop!important}", map: undefined, media: undefined });
...
export { DnDEvent, Drag$1 as Drag, DragAwareMixin$1 as DragAwareMixin, DragMixin$1 as DragMixin, Drop$1 as Drop, DropMask$1 as DropMask, dnd };
