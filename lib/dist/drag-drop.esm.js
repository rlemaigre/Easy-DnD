...
var Drag = /*@__PURE__*/(function (Vue) {
    function Drag() {
    ...
    if ( Vue ) Drag.__proto__ = Vue;
    Drag.prototype = Object.create( Vue && Vue.prototype );
    Drag.prototype.constructor = Drag;

    var prototypeAccessors = { showDragImage: { configurable: true },dndtype: { configurable: true },dnddata: { configurable: true },dragIn: { configurable: true },clazz: { configurable: true } };
    Drag.prototype.onMouseEnter = function onMouseEnter () {
        this.mouseIn = true;
    };
    Drag.prototype.onMouseLeave = function onMouseLeave () {
        this.mouseIn = false;
    };
    Drag.prototype.mounted = function mounted () {
        var comp = this;
        var el = this.$el;
    ...
    prototypeAccessors.dndtype.get = function () {
        return dndimpl.inProgress ? dndimpl.type : null;
    };
    prototypeAccessors.dnddata.get = function () {
...
/* template */
var __vue_render__ = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c(_vm.tag,_vm._g(_vm._b({tag:"component",class:_vm.clazz,style:({cursor: 'grab'}),nativeOn:{"mouseenter":function($event){return _vm.onMouseEnter($event)},"mouseleave":function($event){return _vm.onMouseLeave($event)}},scopedSlots:_vm._u([_vm._l((_vm.$scopedSlots),function(_,slot){return {key:slot,fn:function(scope){return [_vm._t(slot,null,null,scope)]}}})],null,true)},'component',_vm.$attrs,false),_vm.$listeners),[_vm._t("default"),_vm._v(" "),_vm._v(" "),(_vm.showDragImage)?_c('div',{ref:"drag-image",staticClass:"drag-image"},[_vm._t("drag-image",null,{"type":_vm.dndtype,"data":_vm.dnddata})],2):_vm._e()],2)};
var __vue_staticRenderFns__ = [];

  /* style */
  var __vue_inject_styles__ = function (inject) {
    if (!inject) { return }
    inject("data-v-7d5c8a72_0", { source: "", map: undefined, media: undefined })
,inject("data-v-7d5c8a72_1", { source: "html.drag-in-progress *{cursor:grabbing!important}.drag-image{position:fixed;top:-10000px;left:-10000px;will-change:left,top}", map: undefined, media: undefined });

  };
  /* scoped */
  var __vue_scope_id__ = "data-v-7d5c8a72";
  /* module identifier */
...
var Drop = /*@__PURE__*/(function (Vue) {
    function Drop() {
        Vue.apply(this, arguments);
        this.isDrop = true;
    }

    if ( Vue ) Drop.__proto__ = Vue;
    Drop.prototype = Object.create( Vue && Vue.prototype );
    Drop.prototype.constructor = Drop;

    var prototypeAccessors = { clazz: { configurable: true },style: { configurable: true },showDragImage: { configurable: true },dndtype: { configurable: true },dnddata: { configurable: true } };
    Drop.prototype._acceptsType = function _acceptsType (type) {
    ...
    Drop.prototype.mounted = function mounted () {
        var el = this.$el;
        var comp = this;
    ...
    Drop.prototype.compatibleModes = function compatibleModes () {
...
__decorate([
    ...
    __metadata("design:type", Object)
], Drop.prototype, "acceptsType", void 0);
__decorate([
    Prop({ default: function () { return function () { return true; }; }, type: Function }),
    __metadata("design:type", Object)
], Drop.prototype, "acceptsData", void 0);
__decorate([
    Prop({ default: 'pointer' }),
    __metadata("design:type", String)
], Drop.prototype, "cursor", void 0);
__decorate([
    Prop({ default: 'copy' }),
    __metadata("design:type", String)
], Drop.prototype, "mode", void 0);
Drop = __decorate([
    Component({})
], Drop);
var script$1 = Drop;
...
var __vue_staticRenderFns__$1 = [];
  ...
  var __vue_inject_styles__$1 = function (inject) {
    if (!inject) { return }
    inject("data-v-365647c8_0", { source: ".drop-allowed.drop-in *{cursor:inherit!important}.drop-forbidden.drop-in,.drop-forbidden.drop-in *{cursor:no-drop!important}", map: undefined, media: undefined });
...
var DragSensitive = /*@__PURE__*/(function (Vue) {
    function DragSensitive () {
        Vue.apply(this, arguments);
    }

    if ( Vue ) DragSensitive.__proto__ = Vue;
    DragSensitive.prototype = Object.create( Vue && Vue.prototype );
    DragSensitive.prototype.constructor = DragSensitive;
    ...
    Object.defineProperties( DragSensitive.prototype, prototypeAccessors );

    return DragSensitive;
}(Vue));
DragSensitive = __decorate([
    Component({})
], DragSensitive);
var DragSensitive$1 = DragSensitive;

export { DNDEvent, Drag$1 as Drag, DragSensitive$1 as DragSensitive, Drop$1 as Drop, DropMask$1 as DropMask, dnd };
